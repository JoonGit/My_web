...
namespace MyBlog.Data.Service
{
    public class ProudctesService :EntityBaseRepository<ProductModel>, IProudctesService
    {
        ...
        public ProudctesService(BlogDbContext context) : base(context)
        {
        }
        ...
        private async Task<int> Upload(ProductModel model, IFormFileCollection files)
        {
            ...
            // 파일 매소드로 변환
                ...
                {
                filelist.Add(ReadFileToBoundary(file, boundary));
                }
                // 종료 바운더리 설정
        ...
        public byte[] ReadFileToBoundary(IFormFile file, string boundary)
        {
            // 시작 바운더리 설정
